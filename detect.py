...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset: # 載入圖片跑迴圈
        ...
        # Apply NMS
        pred = non_max_suppression(pred, opt.conf_thres, opt.iou_thres, classes=opt.classes, agnostic=opt.agnostic_nms) # 汰留決選的BBOX
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-conf', action='store_true', default=def_save_text, help='save confidences in --save-txt labels')
